...
//	/**
//	 * Sort a {@link Map} by its value.
//	 *
//	 * @param map The {@link Map} to be sorted.
//	 * @return The sorted {@link Map}.
//	 */
//	private Map<String, Participant> sortMapByValue(Map<String, Participant> map) {
//		List<Entry<String, Participant>> list = new LinkedList<>(map.entrySet());
//		list.sort((Entry<String, Participant> e1, Entry<String, Participant> e2) -> {
//			return e1.getValue().getSwimTime().compareTo(e2.getValue().getSwimTime());
//		});
...
//	}
//	/**
//	 * Return the best university on the given {@link Map} of universities.
//	 *
//	 * @param bestUniversities A {@link Map} with all the universities.
//	 * @return The {@link BestUniversity}.
//	 */
//	private BestUniversity getBestUniversity(
//		Map<String, Map<String, Participant>> bestUniversities) {
//
//		logger.info("Starting method: getBestUniversity");
//		final Holder<String> best = new Holder<>();
//		final Holder<Integer> time = new Holder<>(0);
//		final Holder<Integer> avg = new Holder<>(0);
//
//		bestUniversities.forEach((String u, Map<String, Participant> bp) -> {
//			bp.forEach((String ss, Participant p) -> {
//				avg.setValue(avg.getValue() + p.getSwimTime());
//			});
//			if (avg.getValue() < time.getValue()) {
//				time.setValue(avg.getValue());
//				best.setValue(u);
//			}
//		});
//
//		BestUniversity bu = new BestUniversity();
//		bu.setName(best.getValue());
//		bu.setTimes(bestUniversities.get(best.getValue()));
//		return bu;
//	}
}
